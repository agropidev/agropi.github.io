...
(function($){
	...
	$.fn.slideBox = function(params){
		...
		$(divPanel).css("left", (120 - parseInt(defaults.width))/2 + "%");
		...
		// adding buttons
		$(divPanel).append("<div class='slide-button'>Open Twitter</div>");
		$(divPanel).append("<div style='display: none' id='close-button' class='slide-button'>Close Twitter</div>");
